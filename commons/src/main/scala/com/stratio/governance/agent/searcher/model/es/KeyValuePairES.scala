...
object KeyValuePairES {
  ...
  def fromDatabaseSchemaList(databaseSchemaList: List[(DatabaseSchema, KeyValuePair)]): KeyValuePairES = {
  ...
  def fromFileTableList(fileTable: List[(FileTable, KeyValuePair)]): KeyValuePairES = {
  ...
  def fromFileColumnList(fileColumn: List[(FileColumn, KeyValuePair)]): KeyValuePairES = {
  ...
  def fromSqlTableList(sqlTable: List[(SqlTable, KeyValuePair)]): KeyValuePairES = {
  ...
  def fromSqlColumnList(sqlColumn: List[(SqlColumn, KeyValuePair)]): KeyValuePairES = {
