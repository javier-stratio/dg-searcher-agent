/*
 * This class has been extracted from https://github.com/vspy/scala-mustache
 */
...
package com.stratio.governance.agent.searcher.actors.manager.utils.defimpl.mustache {
