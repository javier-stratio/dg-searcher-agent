...
class DGIndexerTest extends FlatSpec {
  ...
  "Extractor No Additionals Events Simulation" should "be processed in Indexer Mock" in {
    ...
    val chunk: Array[DataAssetES] = Array(
      new DataAssetES(1,Option("EmptyStore"),None,Option("Empty DataStore"),"EmptyDatastore:","HDFS","DS","stratio",true, new Timestamp(milis), new Timestamp(milis)),
      new DataAssetES(2,Option("MyDataStore"),None,Option("My DataStore"),"MyDataStore:","SQL","DS","stratio", true, new Timestamp(milis), new Timestamp(milis)),
      new DataAssetES(3,Option("FinantialDB"),None,Option("Finantial DataBase"),"MyDataStore://>FinantialDB/:","SQL","PATH","stratio",true, new Timestamp(milis), new Timestamp(milis)),
      new DataAssetES(4,Option("toys-department"),None,Option("Toys Department"),"MyDataStore://>FinantialDB/:toys-department","SQL","RESOURCE","stratio",true, new Timestamp(milis), new Timestamp(milis)),
      new DataAssetES(5,Option("purchaserName"),None,Option("Purchaser Name"),"MyDataStore://>FinantialDB/:toys-department:purchaserName:","SQL","FIELD","stratio",true, new Timestamp(milis), new Timestamp(milis)),
